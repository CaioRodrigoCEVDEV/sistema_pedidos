...
function stateOf(product) {
  ...
  if (!product.tem_cores && String(product.proacabando || "").trim().toUpperCase() === "S") return ["Últimas unidades", "warning"];
