...
router.post('/usuario/atualizar/:id', autenticarToken, usuarioController.atualizarCadastro);
...
router.post('/usuario/excluir/:id', autenticarToken, usuarioController.excluirCadastro);
